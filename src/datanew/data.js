...

{
  name: "Oasis",
  category: ["NFT"],
  description: "Oasis is an NFT marketplazklince powered by StarkNet. Make offers and list nfts with near zero gas fees. Deploy your nft collection on starknet and oasis.",
...
},
{
  ...
  category: ["Wallet"],
  description:
    "BlockWallet is the first-ever browser extension that gives you an untraceable identity. Reclaim privacy on your ETH, WBTC & ERC-20 transfers.",
...
},
{
  ...
  category: "Dapp",
  description:
    "The Increment protocol introduces a system design that uses pooled virtual assets for liquidity and leverages Curve V2's AMM (Automated Market Maker) for trade execution.",
...
},
{
  ...
  category: "Dapp",
  description:
    "Magnety is an on-chain asset management protocol that allows anyone, such as investment groups, DAOs, or individuals, to get the most out of DeFi through an easy-to-use platform. ",
...
},
{
...
},
 {
  ...
  category: "Dapp",
  description:
    "Phezzan Protocol, a cross chain 19.45% interest earning derivative DEX",
...
},
{
  ...
  category: "Dapp",
  description:
    "Dank is an open-source lending protocol based on smart contracts which allows all valuable crypto assets to obtain multi diversified financial services.",
...
},
{
...
},
 {
  ...
  category: "Dapp",
  description:
    "Hedgey is a permissionless protocol that lets DAOs and treasuries create strategic financing with their tokens through public and private OTC offers, yield bearing covered calls, and time locked auctions.",
...
},
{
 ...
 infra: [
   {
    ...
    },  
    {
      ...
      category: "Infra",
      description:
        "Stakefish is a Proof of Stake service provider with distributed validator nodes that are monitored 24/7.",
 ...
 },
 {
      ...
      category: "Infra",
      description:
        "Angle is the first over-collateralized, decentralized and capital-efficient stablecoin protocol. It offers full convertibility between stable assets and collateral at oracle value.",
 ...
 },
{
 ...
 },
 {
      ...
      category: "Infra",
      description:
        "Simplex is an EU-licensed financial institution and a Level 1 Service Provider, empowering the crypto industry with a full fiat infrastructure.",
  ...
  nfts: [
    ...
    },
    {
      ...
      category: "NFT",
      description:
        "tofuNFT is an NFT marketplace focused on GameFi and collectibles, rebranded from SCV’s NFT market. Enjoy exploring & trading with your buddies!",
...
social: [ 
      ...
      category: "Social",
      description:
        "Poster is a general purpose decentralized social network.",
